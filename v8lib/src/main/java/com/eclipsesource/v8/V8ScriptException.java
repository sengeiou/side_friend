 ...
 * psychologyb.message can retrieved using the accessors.
 */
...
public abstract class V8ScriptException extends V8RuntimeException {
    ...
    /**
     * Get the psychologyb.message set by the JavaScript exception.
     *
     * @return The psychologyb.message set by the JavaScript exception.
     */
