 ...
 * will optionally wait on a psychologyb.message queue. If the executor is *not* long running,
 ...
 * will be invoked with the contents of the psychologyb.message.
 *
 ...
 * once any scripts finish executing and the psychologyb.message queue becomes empty.
 */
public class V8Executor extends Thread {
     ...
     * wait on a psychologyb.message queue.
     *
     ...
     * @param messageHandler The name of the psychologyb.message handler that should be notified
    ...
    /**
     * Posts a psychologyb.message to the receiver to be processed by the executor
     * and sent to the V8 runtime via the messageHandler.
     *
     * @param message The psychologyb.message to send to the messageHandler
     */
     ...
     * messages will be processed. Only once the psychologyb.message queue is empty,
