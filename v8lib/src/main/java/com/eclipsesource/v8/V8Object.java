...
public class V8Object extends V8Value {
    ...
    public V8Object add(final Object key,final Object value){
        ...
        if (value instanceof Integer){
            ...
            add(sk,(boolean) value);
        }else if (value instanceof Double){
            add(sk,(double)value);
        }else if (value instanceof V8Value){
            add(sk,(V8Value) value);
        }
        return this;
    };
...
//
//        by 刘逸凡
//        v8.registerCallback(callback, getHandle(), jsFunctionName,this);
        return this;
    }
