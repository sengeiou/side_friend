...
public class CallAccept {
    ...
    public CallAccept(ZKCallActivity zkCallActivity){
    ...
    private void initView(){
        mView = LayoutInflater.from(mZKCallActivity).inflate(R.layout.call_accept, null);
