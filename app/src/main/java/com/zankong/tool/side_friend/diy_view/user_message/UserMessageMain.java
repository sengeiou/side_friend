...
public class UserMessageMain extends ZKViewAgent {
    ...
    public UserMessageMain(ZKDocument zkDocument, Element element) {
    ...
    public void initView(ViewGroup viewGroup) {
        ...
        findViewById(R.id.layout_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                V8Function v8Function = getZKDocument().genContext("document.open('pangyou/user-message-edit.xml')");
