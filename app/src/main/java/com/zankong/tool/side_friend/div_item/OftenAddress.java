 ...
 */
@ZKAppAdapter("oftenAddress")
public class OftenAddress extends ZKAdapter{
    public OftenAddress(ZKDocument zKDocument, Element element) {
        super(zKDocument, element);
    }

    @Override
    protected RecyclerView.ViewHolder onCreate(@NonNull ViewGroup viewGroup, int i) {
        return new OftenAddress.ViewHolder(mLayoutInflater.inflate(R.layout.address_often,viewGroup,false));
    }
