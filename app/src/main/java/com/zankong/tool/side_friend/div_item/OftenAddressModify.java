 ...
 */
@ZKAppAdapter("oftenAddressModify")
public class OftenAddressModify extends ZKAdapter{
    public OftenAddressModify(ZKDocument zKDocument, Element element) {
        super(zKDocument, element);
    }

    @Override
    protected RecyclerView.ViewHolder onCreate(@NonNull ViewGroup viewGroup, int i) {
        return new OftenAddressModify.ViewHolder(mLayoutInflater.inflate(R.layout.address_often,viewGroup,false));
    }
