...
public class Config {
    ...
    public static String apiKey = "gba5E9vyMMLS8o11DsuETt1e";
    public static String secretKey = "jfFLfHaGH8iKe8dKXmjySXjFx08u0SnM";
    public static String licenseID = "PangYou-face-android";
     ...
     */
    public static String groupID = "14815769";
